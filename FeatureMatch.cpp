...
int main() 
{
    ...
    //Feacture detector and extractor
    cv::Mat desc;
    ...
    for(;;) 
    {
       ...
       //call to detector, extractor and matcher 
	...
	//drawing the bounding box around the image roi
